...
//        getTest().log.log(Status.INFO, message,        MediaEntityBuilder.createScreenCaptureFromBase64String(base64Image).build());
//    }
//
...
//        String base64Image = "data:image/png;base64,"
//                + ((TakesScreenshot) BaseSetup.getDriver()).getScreenshotAs(OutputType.BASE64);
//        getTest().log.log(status, message,               MediaEntityBuilder.createScreenCaptureFromBase64String(base64Image).build());
//    }
